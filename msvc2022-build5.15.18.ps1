...
$qt_sources_url = "https://download.qt.io/archive/qt/" + $version_base + "/" + $version + "/single/qt-everywhere-opensource-src-" + $version + ".zip"
...
# 1.1.1d
# Install steps:
#   1. Download, unpack openssl to folder "C:\openssl\src".
